...
class _AddSchedule extends State<AddSchedule>{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 80,
        title: const Text('Add schedule', style: TextStyle(fontSize: 25, color: Colors.black, fontWeight: FontWeight.bold,),),
        elevation: 0.0,
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: FormBuilder(
            key: _formkey,
            onChanged: (){
              if (kDebugMode) {print("Form has been changed");}
            },
            ...
            child: Column(
              ...
              children: [
                ...
                timeSet
                  ...
                  validator: _formkey.currentState?.fields['timeSet']?.value,
                  name: 'start_time',
  ...
  void submitAction() {
    ...
    if(validationSuccess == true){
      ...
      if(dayToDo == 'when_tomorrow'){
        when = DateTime.now().add(const Duration(days:1)).toString().substring(0, 10);
      }
